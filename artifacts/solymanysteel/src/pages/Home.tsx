...
import heroImg from '@assets/generated_images/hero-home.jpg';
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            ...
            <Link href="/services">
              <span className="text-primary hover:text-white font-bold flex items-center gap-2 transition-colors cursor-pointer uppercase text-sm tracking-wider">
                عرض كل الخدمات <ArrowIcon className="w-4 h-4" />
              </span>
            </Link>
          </div>
      ...
      <section className="py-24 md:py-32 bg-card border-y border-border relative">
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            ...
            <Link href="/products">
              <span className="text-primary hover:text-white font-bold flex items-center gap-2 transition-colors cursor-pointer uppercase text-sm tracking-wider">
                استكشف المنتجات <ArrowIcon className="w-4 h-4" />
              </span>
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { img: project1Img, title: t('products.p1') },
              { img: project2Img, title: t('products.p2') },
              { img: project3Img, title: t('products.p3') },
            ].map((p, i) => (
          ...
          <div className="bg-primary/10 border border-primary/20 rounded-3xl p-10 md:p-20 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
                {t('contact.desc') || 'نحن هنا لمناقشة متطلبات مشاريعكم وتقديم أفضل الحلول المتكاملة.'}
              </p>
